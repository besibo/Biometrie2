...
Attention, sur les ordinateurs de l'université cette procédure ne fonctionne pas toujours. Si vous rencontrez des difficultés, suivez les instructions décrites à la fin de cette section \@ref(prerequis)
...
- [cases](data/cases.rda)
- [population](data/population.rda)
- [rates](data/rates.rda)
- [storms](data/storms.rda)
