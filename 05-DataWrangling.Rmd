...
```{r, inner, echo = FALSE, out.width='50%', fig.align='center', fig.cap="Schéma de la fonction `inner_join()` tiré de la 'cheatsheet' de `dplyr` et `tidyr`"}
...
```{r, left, echo = FALSE, out.width='50%', fig.align='center', fig.cap="Schéma de la fonction `left_join()` tiré de la 'cheatsheet' de `dplyr` et `tidyr`"}
