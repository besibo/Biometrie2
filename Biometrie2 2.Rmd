...
```{r, brew, RcolorbrewerPalettes, echo = FALSE, out.width='50%', fig.align='center', fig.cap="Toutes les palettes de couleur du package `RColorBrewer`."}
...
2. Installez le package `EDAWR` grâce à la fonction `install_github()` du package `devtools` :
