...
```{r warning=FALSE, tidy=FALSE, message=FALSE, fig.cap="Distribution des températures avec visualisation des données mensuelles.", fig.pos = '!htpb'}
...
```{r wrap, warning=FALSE, tidy=FALSE, message=FALSE, fig.asp=1.2, fig.cap='(ref:wrap)', fig.pos = '!htpb'}
ggplot(weather, aes(x = temp, fill = factor(month))) +
  geom_histogram(bins = 20, color = "grey30") +
...
```{r grid, warning=FALSE, tidy=FALSE, message=FALSE, fig.asp=1.2, fig.cap="(ref:grid)", fig.pos = '!htpb'}
ggplot(weather, aes(x = temp, fill = factor(month))) +
  geom_histogram(bins = 20, color = "grey30") +
...
carrier_table <- flights %>%   # On prend flights, puis...
  ...
  arrange(desc(nombre))        # On trie le tableau par nb de vols décroissant
...
```{r theme1, fig.asp = 1, tidy=FALSE, warning = FALSE, fig.cap="(ref:gray)"}
ggplot(flights, aes(x = fct_infreq(carrier), fill = origin)) +
  geom_bar(color = "black") +
  facet_wrap(~origin, ncol = 1) +
  labs(x = "Compagnie aérienne",
...
```{r themebw, fig.asp = 1, tidy=FALSE, warning = FALSE, fig.cap="(ref:bw)"}
ggplot(flights, aes(x = fct_infreq(carrier), fill = origin)) +
  geom_bar(color = "black") +
  facet_wrap(~origin, ncol = 1) +
  labs(x = "Compagnie aérienne",
...
```{r themefont, fig.asp = 1, tidy=FALSE, warning = FALSE, fig.cap="Modification de la police de caractères."}
ggplot(flights, aes(x = fct_infreq(carrier), fill = origin)) +
  geom_bar(color = "black") +
  facet_wrap(~origin, ncol = 1) +
  labs(x = "Compagnie aérienne",
